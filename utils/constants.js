...
module.exports.MESSAGES = {
  ...
  uncorrectDataImg: 'Переданы некорректные данные: ссылка на изображение.',
  uncorrectDataTrailer: 'Переданы некорректные данные: ссылка на трейлер.',
  uncorrectDataThumb: 'Переданы некорректные данные: ссылка на преьвю.',
